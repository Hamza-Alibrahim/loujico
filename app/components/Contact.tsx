...
const Contact = () => {
  ...
  const validateField = (name: string, value: string) => {
    switch (name) {
      case "name":
        if (!value.trim()) {
          return t("errors.nameRequired") || "Name is required";
        } else if (value.trim().length < 2) {
          return (
            t("errors.nameTooShort") || "Name must be at least 2 characters"
          );
        }
        return "";
      ...
      case "email":
        if (!value.trim()) {
          return t("errors.emailRequired") || "Email is required";
      ...
      case "message":
        if (!value.trim()) {
          return t("errors.messageRequired") || "Message is required";
