      ...
      <AnimatePresence>
        {isLanguageOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-40 bg-deep-space/95 backdrop-blur-xl border border-electric-violet/30 rounded-xl shadow-2xl shadow-electric-violet/20 overflow-hidden z-50"
          >
            <div className="p-2">
